...
const { getOpDatas, getOpModuleData, insertOpcount, updatOutpatientModuleTbl, deleteOpData, updatOpCount, updateCashcreditCount, deleteOpCashCreditData, updateOpCashCreditData, getIpModuleData, insertIpAdmissionDatas, UpdateIpAdmsnModuleTbl, updateDischargeCount, UpdateIpDischgModuleTbl } = require('./bis_data_push.service');
module.exports = {
    ...
    getIpModuleData: (req, res) => {
        getIpModuleData((err, results) => {
            if (err) {
                return res.status(200).json({
                    success: 0,
                    message: err
